        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("".concat(API_URL, "/categories"), {
                            method: 'POST',
                ...
                case 2:
                    json = _b.sent();
                    if (!res.ok) {
                        throw new Error((json === null || json === void 0 ? void 0 : json.message) || 'Error al guardar la categoría');
                    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, createCategory(cleanName, description.trim() || undefined)];
                case 2:
                    created = _a.sent();
                    onSuccess(created);
                    onClose();
                ...
                case 3:
                    err_1 = _a.sent();
                    setError(err_1 instanceof Error ? err_1.message : 'Error al guardar la categoría');
                    return [3 /*break*/, 5];
                case 4:
                    setLoading(false);
                    return [7 /*endfinally*/];
      ...
      <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="grid gap-4">
          <div className="grid gap-2">
            ...
            <input className="rounded-lg border px-3 py-2" value={name} onChange={function (e) { return setName(e.target.value); }} placeholder="Ej: Remeras" required/>
          </div>
