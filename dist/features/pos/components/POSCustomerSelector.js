...
function CustomerSelector(_a) {
        ...
        var timer = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        data = (_b.sent()).data;
                        setResults(unwrapCustomers(data === null || data === void 0 ? void 0 : data.data));
                        return [3 /*break*/, 3];
                    case 2:
                        _a = _b.sent();
                        setResults([]);
    ...
    return (<div className="relative">
      <input value={query} onChange={function (e) {
            ...
            setIsOpen(true);
        }} onFocus={function () { return setIsOpen(true); }} placeholder="Buscar cliente (opcional)..." className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"/>
      ...
      {isOpen && results.length > 0 && (<div className="absolute z-10 w-full mt-1 bg-white border rounded-lg shadow-lg max-h-48 overflow-y-auto">
          {results.map(function (c) { return (<button key={c.id} onClick={function () {
                    onSelect(c);
                    setQuery('');
                    setIsOpen(false);
