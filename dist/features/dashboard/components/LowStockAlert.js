...
exports.LowStockAlert = void 0;
var lucide_react_1 = require("lucide-react");
var LowStockAlert = function (_a) {
    var products = _a.products;
    if (products.length === 0)
        return null;
    return (<div className="bg-white p-6 rounded-lg shadow-sm border">
      <div className="flex items-center mb-4">
        <lucide_react_1.AlertTriangle className="h-5 w-5 text-orange-500 mr-2"/>
        <h3 className="text-lg font-semibold text-gray-900">Productos con Stock Bajo</h3>
      </div>
      <div className="space-y-3">
        {products.map(function (product) { return (<div key={product.id} className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
            <div>
